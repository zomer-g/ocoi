...
# Default prompts (from ocoi-extractor coi_extraction.py)
_DEFAULT_SYSTEM_PROMPT = """You are an expert analyst specializing in Israeli conflict of interest arrangements (הסדרים למניעת ניגוד עניינים).
...
_DEFAULT_USER_PROMPT = """Analyze this Israeli conflict of interest (ניגוד עניינים) document.
